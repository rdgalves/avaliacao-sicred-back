...
public class SessaoVotacaoException extends BaseAvaliacaoException {
    private static final long serialVersionUID = 1L;
    private MessageSource messageSource;
    private String messageKey;
    private Object[] params;

    public SessaoVotacaoException(MessageSource messageSource, String messageKey, Object... params) {
        super();
